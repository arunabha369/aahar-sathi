...
export function Hero() {
  return (
    <section aria-labelledby="hero-heading" className="relative isolate overflow-hidden">
      {/* A faint lime wash at the top — no glow blobs, so the illustration stays the brightest thing. */}
      <div aria-hidden="true" className="absolute inset-x-0 top-0 -z-10 h-[44rem] bg-linear-to-b from-brand-50/80 via-canvas to-canvas" />
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-4 pb-20 pt-12 sm:px-6 lg:grid-cols-[1.02fr_1fr] lg:gap-10 lg:px-8 lg:pb-28 lg:pt-20">
        <div className="text-center lg:text-left">
          <p className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-surface px-3.5 py-1.5 text-[0.8125rem] font-semibold text-brand-800">
          ...
          >
            Dal, roti, rice —<span className="block text-accent">portioned for your goal.</span>
          </h1>
